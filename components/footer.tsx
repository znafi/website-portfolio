  ...
  return (
    <footer id="contact" ref={ref} className="px-6 py-32 md:py-40">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <p className="mb-4 text-[11px] font-medium uppercase tracking-[0.2em] text-muted-foreground/50">
            06 / Contact
          </p>
          ...
          <a
            ...
            className="group inline-flex items-center gap-3 rounded-full bg-foreground px-8 py-4 text-sm font-medium text-background transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
